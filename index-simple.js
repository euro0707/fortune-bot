...
// キャッチコピー辞書（FlexMessage用 - 絵文字なし）
const typeCatchPhrases = {
  '111': '情熱の起爆剤 自ら道を切り拓くタイプ',
  '222': '共感力の天才 優しさで場を和ませるタイプ',
  '333': '自由な発想家 自分らしく突き抜けるタイプ',
  '444': '職人肌の努力家 着実に物事を積み上げるタイプ',
  '555': '面倒見のいいリーダー みんなの中心に立つタイプ',
  '666': '影の支配者 裏で力を発揮するタイプ',
  '777': '鋭い直感の観察者 真実を見抜くタイプ',
  '888': '意志の強い突破者 逆境を力に変えるタイプ',
  '999': '理想を追う旅人 常に成長し続けるタイプ',
  '000': '天才型の変わり者 独自の世界観を持つタイプ',
  '999+': '神秘と現実をつなぐ橋 超越したハイブリッドタイプ',
  '001': '純粋な理想家 新しい可能性を見出すタイプ',
  '012': 'バランス調整者 調和を重視するタイプ',
  '024': '着実な実行者 責任感の強いタイプ',
  '025': '創造的な実践者 バランスの取れたタイプ',
  '100': '情熱のパイオニア 挑戦者タイプ',
  '108': '洞察力の達人 深い思考を持つタイプ',
  '125': '協調性のリーダー チームワークを大切にするタイプ',
  '789': '多彩な才能家 適応力のあるタイプ',
  '919': '独立した探求者 自分の道を歩むタイプ'
};
...
const personalityData = {
  ...
  '001': {
    name: '純粋な理想家',
    summary: '純粋で理想を追い求める心を持つタイプ。新しい可能性を見出す力があります。',
  ...
  '919': {
    name: '独立した探求者',
    summary: '自分の道を歩む独立心があり、新しい発見を求める探求心を持つタイプ。',
